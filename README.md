# Proyek Book Chapter: Perencanaan Transportasi

Proyek ini merupakan kolaborasi penulisan bab buku (*book chapter*) berjudul **"Perencanaan Transportasi"** yang menjadi bagian dari buku **"Manajemen Transportasi"**. Bab ini ditulis oleh dosen Perencanaan Wilayah dan Kota Institut Teknologi Sumatera (ITERA).

Manajemen proyek dalam repositori ini terinspirasi oleh pendekatan **ICM** oleh Jake Van Clief dan David McDermott sebagaimana dijelaskan dalam artikel terkait: **[Artikel Terkait ICM](https://arxiv.org/html/2603.16021v2)**.
...
Buku ini diproduksi menggunakan **Quarto** dengan ketentuan berikut:
- **Format Output**: `.docx` (Microsoft Word)
- **Ukuran Kertas**: A4
- **Margin**: Atas 3 cm, Bawah 3 cm, Dalam 4 cm, Luar 3 cm (format bolak-balik / *mirrored*)
